...
class CaptionModel(nn.Module):
                ...
                if t >= divm and t <= self.seq_length + divm - 1:
                    ...
                    for vix in range(bdash):
                        if beam_seq_table[divm][t-divm,vix] == 0 or t == self.seq_length + divm - 1:
                            ...
                            #print(t, divm, t-divm, vix, final_beam)
                            #final_beam['p'] = final_beam['p'] / (0.01 + t - divm)** 0.5 * (1.0)**1
                            if max_ppl:
    ...
    def beam_search_mixed_objective(self, init_state, init_logprobs, *args, **kwargs):
